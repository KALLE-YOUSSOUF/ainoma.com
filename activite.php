			...
			<div class="wrapper">
				...
				<div class="wrapper pad_top1">
					<section class="col2">
						...
						<p class="pad_bot2">
							<span class="color1">Lorem ipsum dolor sit amet, consectetur adipisicing.</span><br>
							Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo.
						</p>
					</section>
					<section class="col3 pad_left1">
						<span class="dropcap1"><span class="color1">02</span></span>
						<p class="pad_bot2">
							<span class="color1">Excepteur sint occaecat cupidatat.</span><br>
				...
				<div class="wrapper pad_top1">
					<section class="col2">
						...
						<span class="color1">Proident sunt in culpa qui officia deserunt.</span><br>
						Totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt.
					</section>
					<section class="col3 pad_left1">
						<span class="dropcap1"><span class="color3">04</span></span>
						<span class="color1">Proident sunt in culpa qui officia deserunt.</span><br>
						Totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt.
					</section>
				</div>
		...
		<article id="content2">
			...
			<div class="quality">
				<div class="cols arrow">
					<div class="wrapper">
						<span class="dropcap1"><span>a</span></span>
